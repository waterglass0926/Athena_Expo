...
import ShopeeV2Routes from '@/routes/stacks/shopee/v2/routes';
import Counter from '@/components/shopee/v2/Counter';
import Button from '@/components/shopee/v2/Button';
import theme from '@/components/shopee/v2/theme';
...
export default class ProductList extends React.Component {
  ...
  onProductListPress(product, index) {
    this.props.navigator.push(
      ShopeeV2Routes.getRoute('ProductDetails', {
        product

...
const data = [
  {
    type: 'Welcome',
    imageUri: Constants.IAMGES.SERENITY.WELCOME,
  ...
  {
    type: 'Grant Access',
    imageUri: Constants.IAMGES.SERENITY.FILES,
  ...
  // {
  //   type: 'Youtube',
  //   imageUri: Constants.IAMGES.SERENITY.YOUTUBE,
  ...
  {
    type: 'Ready',
    imageUri: Constants.IAMGES.SERENITY.READY,
    heading: 'Let\'s Go',
...
const Item = ({
  ...
  function renderAction() {
    switch (type) {
      case 'Grant Access':
        return <Components.LocalLibraryAccess color={color} next={next} />;
      case 'Youtube':
        return <Components.GoogleLogin next={next} color={color} />;
      case 'Welcome':
        return (
          <Button
            mode='contained'

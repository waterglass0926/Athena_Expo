...
import { ChatClientService, useStreamChatTheme } from '@/utils/slack';

export const TargettedMessageChannel = () => {
  ...
  return (
    <SafeAreaView
      ...
      <View style={styles.channelScreenContainer}>
        <Components.ChannelHeader channel={channel} goBack={navigation.goBack} />

    ...
    <View style={{ width: '100%', height: '100%', backgroundColor: 'white' }}>
      ...
      <ScrollView style={{ margin: 10 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row', paddingVertical: 10 }}>
          {Constants.DATA.INSTAGRAM.FRIENDS.slice(0, 3).map((data, index) => {
            return (
              <TouchableOpacity
                onPress={() =>
                  navigation.push('InstagramV1FriendProfile', {
                    name: data.name,
        ...
        {Constants.DATA.INSTAGRAM.FRIENDS.slice(3, 6).map((data, index) => {
        ...
        {Constants.DATA.INSTAGRAM.FRIENDS.slice(6.12).map((data, index) => {
          const [follow, setFollow] = useState(data.follow);

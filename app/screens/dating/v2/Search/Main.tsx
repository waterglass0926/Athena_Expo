...
import { getAllEvent } from '@/services/apis/dating/v2/categories';
import { styles } from '@/styles/dating/v2/search';

export function SearchMain({ navigation }) {
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <SearchCard
              ...
              onPress={() => {
                navigation.navigate('DatingV2EventsDetail', {
                  title: item.Adi,
                  id: item.Id,
                });
              }}

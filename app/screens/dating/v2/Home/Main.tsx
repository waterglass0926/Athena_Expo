...
import { FeaturedEvent } from '@/components/dating/v2/Home/FeaturedEvent';
import { EventsList } from '@/components/dating/v2/Events/List';
import { styles } from '@/styles/dating/v2/home';
import { getAllEvent, getOldEvents } from '@/services/apis/dating/v2/categories';

export function HomeMain({ navigation }) {

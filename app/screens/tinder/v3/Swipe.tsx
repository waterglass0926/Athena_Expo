...
const Swipe = () => {
  const [profile, setProfile] = useState(Constants.DATA.TINDER.V3.PROFILE_MOCKS);
  ...
  const reset = () => {
    setProfile(Constants.DATA.TINDER.V3.PROFILE_MOCKS);
    setRemoved([]);
  };
        ...
        {profile.map((profile, index) => (
          ...
          >
            ...
            >
              <Image
                style={styles.image}
                source={require('@/assets/images/tinder/v3/placeholder.jpg')}
                contentFit='cover'
                transition={1000}
              />

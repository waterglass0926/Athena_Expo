...
export default () => {
  ...
  const getChatStyle = () => {
    return {
      ...
      'messageInput.container': `border-top-color: #979A9A; border-top-width: 0.4px; backgroundColor: ${colors.background
      ...
      'messageInput.fileUploadPreview.attachmentContainerView': `border-color: ${colors.border
        }`,
      'messageInput.suggestions.container': `background-color: ${colors.background
        }`,
      ...
      'message.file.container': `background-color: ${colors.background

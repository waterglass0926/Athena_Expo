...
export default DATA = {
  SLIDES: [
    ...
    { key: 15, title: 'Tinder 1.0', description: 'Dating & Social Platform, Image Swipe Functionality', image: Images.ATHENA.SPLASH104, navigation: 'TinderV1' },
    ...
    { key: 20, title: 'Tinder 2.0', description: 'Dating & Social Platform, Image Swipe Functionality', image: Images.ATHENA.SPLASH108, navigation: 'TinderV2' },
    { key: 21, title: 'Instagram 1.0', description: 'Instagram Clone App Version 1.0', image: Images.ATHENA.SPLASH109, navigation: 'InstagramV1' },
    { key: 22, title: 'Instagram 2.0', description: 'Instagram Clone App Version 2.0', image: Images.ATHENA.SPLASH110, navigation: 'InstagramV2' },
    { key: 23, title: 'Movies 2.0', description: 'The Moviedb Clone App Version 2.0', image: Images.ATHENA.SPLASH111, navigation: 'MoviesV2' },
  ],
  LANGUAGES: [

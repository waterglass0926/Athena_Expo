...
export default DATA = {
  SLIDES: [
    ...
    { key: 5, title: 'TikTok', description: 'Short Video Sharing & Social Media Platform', image: Images.ATHENA.SPLASH105, navigation: 'TiktokStack' },
    ...
    { key: 13, title: 'ChatGpt2.0', description: 'Schedule & Booking System, Management Meetings', image: Images.ATHENA.SPLASH111, navigation: 'ChatGptV2' },

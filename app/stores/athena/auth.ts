...
import authApi from '@/services/apis/athena/auth';
...
// Define your slice
export default athenaAuthSlice = createSlice({
  name: 'athenaAuth',
  initialState,
  reducers: {
...
export const { setToken, setUser, setUserData } = athenaAuthSlice.actions;
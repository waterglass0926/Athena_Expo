...
const content = [
  {
    title: 'Let\'s create.',
    bg: Constants.COLORS.CHATGPT.V2.LIME,
    fontColor: Constants.COLORS.CHATGPT.V2.PINK,
  },
  {
    title: 'Let\'s brainstorm.',
    bg: Constants.COLORS.CHATGPT.V2.BROWN,
    fontColor: Constants.COLORS.CHATGPT.V2.SKY,
  },
  {
    title: 'Let\'s discover.',
    bg: Constants.COLORS.CHATGPT.V2.ORANGE,
    fontColor: Constants.COLORS.CHATGPT.V2.BLUE,
  },
  {
    title: 'Let\'s go.',
    bg: Constants.COLORS.CHATGPT.V2.TEAL,
    fontColor: Constants.COLORS.CHATGPT.V2.YELLOW,
  },
  {
    title: 'ChatGPT.',
    bg: Constants.COLORS.CHATGPT.V2.GREEN,
    fontColor: Constants.COLORS.CHATGPT.V2.PINK,
  },
];

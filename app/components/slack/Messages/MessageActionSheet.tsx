...
import { getFrequentlyUsedReactions } from '@/utils/slack/supportedReactions';
      ...
      options={options.map((option, i) => {
        return (
          <View
            ...
            <SvgXml
              xml={Constants.SVGS.SLACK.CHANNEL.EditTextIcon}
              width={20}
              height={20}
            />
            <SCText
  ...
  return (
    <View style={styles.reactionListContainer}>
      ...
      <TouchableOpacity
        ...
        <SvgXml
          xml={Constants.SVGS.SLACK.CHANNEL.EmojiIcon}
          width={25}
          height={25}
        />
      </TouchableOpacity>

...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/assets/data/fitness/v1/populars` | `/assets/data/fitness/v1/traniers` | `/assets/data/paper/cards` | `/assets/data/spotify` | `/assets/data/tinder/v1/demo` | `/assets/data/ubereats/categories` | `/assets/data/ubereats/foods` | `/assets/data/ubereats/meals` | `/assets/data/ubereats/restaurants` | `/assets/svgs/spotify/Svg.Search` | `/assets/svgs/spotify/Svg.TabHome` | `/assets/svgs/spotify/Svg.TabLibrary` | `/assets/svgs/spotify/Svg.TabSearch` | `/components` | `/components/athena` | `/components/athena/Button` | `/components/athena/Header` | `/components/athena/Input` | `/components/athena/Loading` | `/components/athena/Rating` | `/components/athena/Title` | `/components/athena/UserData` | `/components/athena/UserInfo` | `/components/basketball` | `/components/basketball/Ball` | `/components/basketball/Emoji` | `/components/basketball/Floor` | `/components/basketball/Hoop` | `/components/basketball/Net` | `/components/basketball/Score` | `/components/chatgpt/v1` | `/components/chatgpt/v1/Button` | `/components/chatgpt/v1/Input` | `/components/chatgpt/v1/Page` | `/components/fitness/v1` | `/components/fitness/v1/Category` | `/components/fitness/v1/Popular` | `/components/fitness/v1/Status` | `/components/fitness/v1/Trainer` | `/components/fitness/v1/Workout` | `/components/paper` | `/components/paper/BottomBar` | `/components/paper/Button` | `/components/paper/Cards/Evidence` | `/components/paper/Cards/Ghost` | `/components/paper/Cards/Introduction` | `/components/paper/Cards/Settings` | `/components/paper/Cards/Timer` | `/components/paper/Cards/Tool` | `/components/paper/Picker` | `/components/spotify` | `/components/spotify/AlbumsHorizontal` | `/components/spotify/BarMusicPlayer` | `/components/spotify/CustomTabBar` | `/components/spotify/LineItemCategory` | `/components/spotify/LineItemSong` | `/components/spotify/LinearGradient` | `/components/spotify/ModalHeader` | `/components/spotify/PlaylistItem` | `/components/spotify/ScreenHeader` | `/components/spotify/TouchIcon` | `/components/spotify/TouchText` | `/components/tiktok` | `/components/tiktok/Feed` | `/components/tinder/v1` | `/components/tinder/v1/CardItem` | `/components/tinder/v1/City` | `/components/tinder/v1/Filter` | `/components/tinder/v1/Icon` | `/components/tinder/v1/Message` | `/components/tinder/v1/ProfileItem` | `/components/todolist` | `/components/todolist/P` | `/components/todolist/StarButton` | `/components/todolist/SwipeRow` | `/components/todolist/TabBar` | `/components/todolist/TabDropdown` | `/components/todolist/TabItem` | `/components/todolist/ToDo` | `/components/todolist/ToDoDetail` | `/components/todolist/ToDoForm` | `/components/translator` | `/components/translator/ButtonBase` | `/components/translator/ButtonBorderLess` | `/components/translator/InputBase` | `/components/translator/TypoGraphy` | `/components/ubereats/forms` | `/components/ubereats/forms/AppErrorMessage` | `/components/ubereats/forms/AppForm` | `/components/ubereats/forms/AppFormFeilds` | `/components/ubereats/forms/AppSubmitButton` | `/components/ubereats/forms/ImageInput` | `/components/ubereats/others` | `/components/ubereats/others/About` | `/components/ubereats/others/AppButton` | `/components/ubereats/others/AppHead` | `/components/ubereats/others/CartItems` | `/components/ubereats/others/Categories` | `/components/ubereats/others/CheckoutModal` | `/components/ubereats/others/HeaderTabs` | `/components/ubereats/others/MenuItems` | `/components/ubereats/others/OtherSignin` | `/components/ubereats/others/PaymentButton` | `/components/ubereats/others/PaymentScreen` | `/components/ubereats/others/RestaurantItem` | `/components/ubereats/others/RestaurantMap` | `/components/ubereats/others/Screen` | `/components/ubereats/others/SearchBar` | `/components/ubereats/others/TabCartButton` | `/components/ubereats/others/ViewCart` | `/components/world` | `/components/world/Capital` | `/components/world/Continent` | `/components/world/Country` | `/components/world/Friends` | `/components/world/Post` | `/components/youtube/v1` | `/components/youtube/v1/Buttons` | `/components/youtube/v1/Explore` | `/components/youtube/v1/Navbar` | `/components/youtube/v1/Posts` | `/components/youtube/v1/Sidebar` | `/constants` | `/constants/colors` | `/constants/data` | `/constants/fonts` | `/constants/icons` | `/constants/images` | `/constants/styles` | `/constants/svgs` | `/constants/urls` | `/contexts/spotify/CreateContext` | `/contexts/spotify/SpotifyContext` | `/contexts/translator/CardSequenceContext` | `/contexts/translator/HistoryContext` | `/contexts/translator/TranslateContext` | `/hooks/translator/useKeyboard` | `/hooks/translator/useNavigation` | `/hooks/translator/useRoute` | `/routes` | `/routes/drawers/athena` | `/routes/drawers/translator/home` | `/routes/drawers/world/main` | `/routes/stacks/athena` | `/routes/stacks/basketball` | `/routes/stacks/chatgpt/v1` | `/routes/stacks/chatgpt/v1/auth` | `/routes/stacks/chatgpt/v1/home` | `/routes/stacks/famous` | `/routes/stacks/fitness/v1` | `/routes/stacks/fitness/v1/auth` | `/routes/stacks/fitness/v1/home` | `/routes/stacks/paper` | `/routes/stacks/spotify` | `/routes/stacks/spotify/home` | `/routes/stacks/spotify/library` | `/routes/stacks/spotify/main` | `/routes/stacks/spotify/search` | `/routes/stacks/tiktok` | `/routes/stacks/tiktok/discover` | `/routes/stacks/tiktok/home` | `/routes/stacks/tiktok/inbox` | `/routes/stacks/tiktok/profile` | `/routes/stacks/tinder/v1` | `/routes/stacks/todolist` | `/routes/stacks/translator` | `/routes/stacks/translator/home` | `/routes/stacks/ubereats` | `/routes/stacks/ubereats/auth` | `/routes/stacks/ubereats/home` | `/routes/stacks/world` | `/routes/stacks/world/auth` | `/routes/stacks/world/feed` | `/routes/stacks/world/home` | `/routes/stacks/world/profile` | `/routes/stacks/youtube/v1` | `/routes/tabs/athena` | `/routes/tabs/chatgpt/v1/bottom` | `/routes/tabs/fitness/v1/bottom` | `/routes/tabs/spotify/bottom` | `/routes/tabs/tiktok/bottom` | `/routes/tabs/tinder/v1/bottom` | `/routes/tabs/ubereats/bottom` | `/routes/tabs/world/bottom` | `/screens/athena` | `/screens/athena/Language` | `/screens/athena/Slides` | `/screens/athena/Theme` | `/screens/basketball` | `/screens/basketball/Home` | `/screens/basketball/Splash` | `/screens/chatgpt/v1` | `/screens/chatgpt/v1/auth/SignIn` | `/screens/chatgpt/v1/auth/SignUp` | `/screens/chatgpt/v1/auth/Welcome` | `/screens/chatgpt/v1/main/Chat` | `/screens/chatgpt/v1/main/Home` | `/screens/chatgpt/v1/main/Profile` | `/screens/chatgpt/v1/main/Saved` | `/screens/famous` | `/screens/famous/Choose` | `/screens/famous/Finish` | `/screens/famous/Game` | `/screens/famous/Splash` | `/screens/famous/Welcome` | `/screens/fitness/v1` | `/screens/fitness/v1/auth/SignIn` | `/screens/fitness/v1/auth/SignUp` | `/screens/fitness/v1/auth/Start` | `/screens/fitness/v1/home` | `/screens/paper` | `/screens/paper/Home` | `/screens/paper/Splash` | `/screens/spotify` | `/screens/spotify/Album` | `/screens/spotify/Home` | `/screens/spotify/Library` | `/screens/spotify/ModalMoreOptions` | `/screens/spotify/ModalMusicPlayer` | `/screens/spotify/Search` | `/screens/spotify/Splash` | `/screens/tiktok` | `/screens/tiktok/discover` | `/screens/tiktok/home` | `/screens/tiktok/home/feed` | `/screens/tiktok/inbox` | `/screens/tiktok/profile` | `/screens/tiktok/splash` | `/screens/tinder/v1` | `/screens/tinder/v1/Home` | `/screens/tinder/v1/Matches` | `/screens/tinder/v1/Messages` | `/screens/tinder/v1/Profile` | `/screens/tinder/v1/Splash` | `/screens/todolist` | `/screens/todolist/Splash` | `/screens/todolist/ToDoList` | `/screens/translator` | `/screens/translator/card-sequence` | `/screens/translator/card-sequence/Header` | `/screens/translator/card-sequence/TranslatorCard` | `/screens/translator/credit` | `/screens/translator/full` | `/screens/translator/history` | `/screens/translator/history/Header` | `/screens/translator/history/HistoryCard` | `/screens/translator/home` | `/screens/translator/home/DrawerContent` | `/screens/translator/home/Header` | `/screens/translator/home/Input` | `/screens/translator/home/LanguageSelector` | `/screens/translator/home/RecentCard` | `/screens/translator/home/TranslatedCard` | `/screens/translator/oss` | `/screens/translator/oss/Card` | `/screens/translator/oss/Header` | `/screens/translator/splash` | `/screens/ubereats` | `/screens/ubereats/auth/SignIn` | `/screens/ubereats/auth/SignUp` | `/screens/ubereats/auth/Welcome` | `/screens/ubereats/main/Account` | `/screens/ubereats/main/Browser` | `/screens/ubereats/main/Cart` | `/screens/ubereats/main/Checkout` | `/screens/ubereats/main/Details` | `/screens/ubereats/main/Grocery` | `/screens/ubereats/main/Home` | `/screens/ubereats/main/Success` | `/screens/world` | `/screens/world/auth/SignIn` | `/screens/world/auth/SignUp` | `/screens/world/auth/Start` | `/screens/world/feed` | `/screens/world/home` | `/screens/world/profile` | `/screens/youtube/v1` | `/screens/youtube/v1/Home` | `/screens/youtube/v1/Splash` | `/services/apis/athena/auth` | `/services/apis/famous/main` | `/services/apis/fitness/v1/main` | `/services/apis/world/main` | `/stores` | `/stores/athena` | `/stores/athena/auth` | `/stores/fitness/v1/main` | `/stores/todolist/todo` | `/stores/todolist/todolist` | `/stores/ubereats/auth` | `/stores/ubereats/basket` | `/stores/world/main` | `/styles/tiktok` | `/styles/tiktok/discover` | `/styles/tiktok/feed` | `/styles/tiktok/home` | `/styles/tiktok/inbox` | `/styles/tiktok/profile` | `/styles/tinder/v1` | `/types/athena` | `/types/translator` | `/types/translator/declarations.d` | `/utils` | `/utils/device` | `/utils/firebase` | `/utils/http` | `/utils/i18n` | `/utils/preload/fonts` | `/utils/preload/images` | `/utils/storage` | `/utils/translate` | `/utils/vector`;

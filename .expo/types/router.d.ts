...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/components` | `/components/__tests__/ThemedText-test` | `/components/athena` | `/components/athena/Collapsible` | `/components/athena/ExternalLink` | `/components/athena/HelloWave` | `/components/athena/Loading` | `/components/athena/ParallaxScrollView` | `/components/athena/TabBarIcon` | `/components/athena/ThemedText` | `/components/athena/ThemedView` | `/components/chatgpt/version1.0` | `/components/chatgpt/version1.0/Button` | `/components/chatgpt/version1.0/Input` | `/components/chatgpt/version1.0/Page` | `/components/chatgpt/version2.0` | `/components/chatgpt/version2.0/AnimatedIntro` | `/components/chatgpt/version2.0/BottomLoginSheet` | `/components/chatgpt/version2.0/ChatMessage` | `/components/chatgpt/version2.0/ChatPage` | `/components/chatgpt/version2.0/DropDownMenu` | `/components/chatgpt/version2.0/HeaderDropDown` | `/components/chatgpt/version2.0/MessageIdeas` | `/components/chatgpt/version2.0/MessageInput` | `/constants` | `/constants/colors` | `/constants/data` | `/constants/fonts` | `/constants/icons` | `/constants/images` | `/constants/styles` | `/constants/svgs` | `/constants/urls` | `/contexts/chatgpt/version2.0/RevenueCat` | `/login` | `/routes` | `/routes/drawers/athena` | `/routes/stacks/athena` | `/routes/stacks/chatgpt/version1.0` | `/routes/stacks/chatgpt/version1.0/auth` | `/routes/stacks/chatgpt/version1.0/home` | `/routes/tabs/athena` | `/routes/tabs/chatgpt/version1.0/bottom` | `/screens/athena` | `/screens/athena/Language` | `/screens/athena/Slides` | `/screens/athena/Theme` | `/screens/chatgpt/version1.0` | `/screens/chatgpt/version1.0/auth/SignIn` | `/screens/chatgpt/version1.0/auth/SignUp` | `/screens/chatgpt/version1.0/auth/Welcome` | `/screens/chatgpt/version1.0/main/Chat` | `/screens/chatgpt/version1.0/main/Home` | `/screens/chatgpt/version1.0/main/Profile` | `/screens/chatgpt/version1.0/main/Saved` | `/screens/chatgpt/version2.0` | `/services/apis/athena/auth` | `/stores` | `/stores/athena` | `/types/athena` | `/types/chatgpt/version2.0` | `/utils` | `/utils/http` | `/utils/i18n` | `/utils/images` | `/utils/sqlite`;

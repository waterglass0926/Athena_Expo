...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/assets/data/ubereats/categories` | `/assets/data/ubereats/foods` | `/assets/data/ubereats/meals` | `/assets/data/ubereats/restaurants` | `/components` | `/components/__tests__/ThemedText-test` | `/components/athena` | `/components/athena/Collapsible` | `/components/athena/ExternalLink` | `/components/athena/HelloWave` | `/components/athena/Loading` | `/components/athena/ParallaxScrollView` | `/components/athena/TabBarIcon` | `/components/athena/ThemedText` | `/components/athena/ThemedView` | `/components/chatgpt/version1.0` | `/components/chatgpt/version1.0/Button` | `/components/chatgpt/version1.0/Input` | `/components/chatgpt/version1.0/Page` | `/components/tiktok` | `/components/tiktok/Feed` | `/components/ubereats/forms` | `/components/ubereats/forms/AppErrorMessage` | `/components/ubereats/forms/AppForm` | `/components/ubereats/forms/AppFormFeilds` | `/components/ubereats/forms/AppSubmitButton` | `/components/ubereats/forms/ImageInput` | `/components/ubereats/others` | `/components/ubereats/others/About` | `/components/ubereats/others/AppButton` | `/components/ubereats/others/AppHead` | `/components/ubereats/others/CartItems` | `/components/ubereats/others/Categories` | `/components/ubereats/others/CheckoutModal` | `/components/ubereats/others/HeaderTabs` | `/components/ubereats/others/MenuItems` | `/components/ubereats/others/OtherSignin` | `/components/ubereats/others/PaymentButton` | `/components/ubereats/others/PaymentScreen` | `/components/ubereats/others/RestaurantItem` | `/components/ubereats/others/RestaurantMap` | `/components/ubereats/others/Screen` | `/components/ubereats/others/SearchBar` | `/components/ubereats/others/TabCartButton` | `/components/ubereats/others/ViewCart` | `/constants` | `/constants/colors` | `/constants/data` | `/constants/fonts` | `/constants/icons` | `/constants/images` | `/constants/styles` | `/constants/svgs` | `/constants/urls` | `/routes` | `/routes/drawers/athena` | `/routes/stacks/athena` | `/routes/stacks/chatgpt/version1.0` | `/routes/stacks/chatgpt/version1.0/auth` | `/routes/stacks/chatgpt/version1.0/home` | `/routes/stacks/tiktok` | `/routes/stacks/tiktok/discover` | `/routes/stacks/tiktok/home` | `/routes/stacks/tiktok/inbox` | `/routes/stacks/tiktok/profile` | `/routes/stacks/ubereats` | `/routes/stacks/ubereats/auth` | `/routes/stacks/ubereats/home` | `/routes/tabs/athena` | `/routes/tabs/chatgpt/version1.0/bottom` | `/routes/tabs/tiktok/bottom` | `/routes/tabs/ubereats/bottom` | `/screens/athena` | `/screens/athena/Language` | `/screens/athena/Slides` | `/screens/athena/Theme` | `/screens/chatgpt/version1.0` | `/screens/chatgpt/version1.0/auth/SignIn` | `/screens/chatgpt/version1.0/auth/SignUp` | `/screens/chatgpt/version1.0/auth/Welcome` | `/screens/chatgpt/version1.0/main/Chat` | `/screens/chatgpt/version1.0/main/Home` | `/screens/chatgpt/version1.0/main/Profile` | `/screens/chatgpt/version1.0/main/Saved` | `/screens/tiktok` | `/screens/tiktok/discover` | `/screens/tiktok/home` | `/screens/tiktok/home/feed` | `/screens/tiktok/inbox` | `/screens/tiktok/profile` | `/screens/tiktok/splash` | `/screens/ubereats` | `/screens/ubereats/auth/SignIn` | `/screens/ubereats/auth/SignUp` | `/screens/ubereats/auth/Welcome` | `/screens/ubereats/main/Account` | `/screens/ubereats/main/Browser` | `/screens/ubereats/main/Cart` | `/screens/ubereats/main/Checkout` | `/screens/ubereats/main/Details` | `/screens/ubereats/main/Grocery` | `/screens/ubereats/main/Home` | `/screens/ubereats/main/Success` | `/services/apis/athena/auth` | `/stores` | `/stores/athena` | `/stores/ubereats/auth` | `/stores/ubereats/basket` | `/styles/tiktok` | `/styles/tiktok/discover` | `/styles/tiktok/discover copy` | `/styles/tiktok/feed` | `/styles/tiktok/home` | `/styles/tiktok/profile` | `/styles\tiktok\inbox` | `/types/athena` | `/utils` | `/utils/firebase` | `/utils/http` | `/utils/i18n`;

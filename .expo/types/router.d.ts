...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/components` | `/components/__tests__/ThemedText-test` | `/components/athena` | `/components/athena/Collapsible` | `/components/athena/ExternalLink` | `/components/athena/HelloWave` | `/components/athena/Loading` | `/components/athena/ParallaxScrollView` | `/components/athena/TabBarIcon` | `/components/athena/ThemedText` | `/components/athena/ThemedView` | `/constants` | `/constants/colors` | `/constants/data` | `/constants/fonts` | `/constants/icons` | `/constants/images` | `/constants/styles` | `/constants/svgs` | `/constants/urls` | `/routes` | `/routes/drawers/athena` | `/routes/stacks/athena` | `/routes/tabs/athena` | `/screens/athena` | `/screens/athena/Language` | `/screens/athena/Slides` | `/screens/athena/Theme` | `/services/apis/athena/auth` | `/stores` | `/stores/athena` | `/types/athena` | `/utils` | `/utils/http` | `/utils/i18n`;

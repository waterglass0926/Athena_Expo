...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/assets/data/dating/v1/data` | `/assets/data/disney/v1` | `/assets/data/fitness/v1/populars` | `/assets/data/fitness/v1/traniers` | `/assets/data/paper/cards` | `/assets/data/tinder/v1/demo` | `/assets/data/ubereats/categories` | `/assets/data/ubereats/foods` | `/assets/data/ubereats/meals` | `/assets/data/ubereats/restaurants` | `/assets/svgs/disney/v1/Svg.ArrowLeft` | `/assets/svgs/disney/v1/Svg.ArrowRight` | `/assets/svgs/disney/v1/Svg.Background` | `/assets/svgs/disney/v1/Svg.CategoryBackground` | `/assets/svgs/disney/v1/Svg.DisneyPlusLogo` | `/assets/svgs/disney/v1/Svg.Downloads` | `/assets/svgs/disney/v1/Svg.Edit` | `/assets/svgs/disney/v1/Svg.Home` | `/assets/svgs/disney/v1/Svg.Plus` | `/assets/svgs/disney/v1/Svg.Search` | `/assets/svgs/disney/v1/Svg.Trash` | `/components` | `/components/athena` | `/components/athena/Button` | `/components/athena/Header` | `/components/athena/Input` | `/components/athena/Loading` | `/components/athena/Rating` | `/components/athena/Title` | `/components/athena/UserData` | `/components/athena/UserInfo` | `/components/basketball` | `/components/basketball/Ball` | `/components/basketball/Emoji` | `/components/basketball/Floor` | `/components/basketball/Hoop` | `/components/basketball/Net` | `/components/basketball/Score` | `/components/chatgpt/v1` | `/components/chatgpt/v1/Button` | `/components/chatgpt/v1/Input` | `/components/chatgpt/v1/Page` | `/components/dating/v1/Header` | `/components/dating/v1/Slider` | `/components/dating/v1/TopHeader` | `/components/dating/v2/Categories/Element` | `/components/dating/v2/Events/List` | `/components/dating/v2/Home/Card` | `/components/dating/v2/Home/FeaturedEvent` | `/components/dating/v2/Search/Card` | `/components/disney/v1` | `/components/disney/v1/Categories` | `/components/disney/v1/Header` | `/components/disney/v1/HeaderAccounts` | `/components/disney/v1/HeaderManage` | `/components/disney/v1/ImageSlide` | `/components/disney/v1/MediaItemScroller` | `/components/disney/v1/SlideShow` | `/components/disney/v1/TouchLineItem` | `/components/disney/v1/TouchLineItemApp` | `/components/disney/v1/TouchLineItemElement` | `/components/disney/v2` | `/components/disney/v2/Banner` | `/components/disney/v2/Card` | `/components/disney/v2/Category` | `/components/disney/v2/Footer` | `/components/disney/v2/Genres` | `/components/disney/v2/Item` | `/components/disney/v2/NavBar` | `/components/disney/v2/Suggestion` | `/components/fitness/v1` | `/components/fitness/v1/Category` | `/components/fitness/v1/Popular` | `/components/fitness/v1/Status` | `/components/fitness/v1/Trainer` | `/components/fitness/v1/Workout` | `/components/instagram/v1` | `/components/instagram/v1/BottomTabView` | `/components/instagram/v1/EditProfile` | `/components/instagram/v1/FriendProfile` | `/components/instagram/v1/Post` | `/components/instagram/v1/ProfileBody` | `/components/instagram/v1/Reels` | `/components/instagram/v1/SearchBox` | `/components/instagram/v1/SearchContent` | `/components/instagram/v1/SingleReel` | `/components/instagram/v1/Status` | `/components/instagram/v1/Stories` | `/components/instagram/v2` | `/components/instagram/v2/DoubleTap` | `/components/instagram/v2/Header` | `/components/instagram/v2/ProgressiveImage` | `/components/movies/v2` | `/components/movies/v2/Cast` | `/components/movies/v2/Loading` | `/components/movies/v2/MovieList` | `/components/movies/v2/TrendingMovies` | `/components/movies/v3` | `/components/movies/v3/CardView` | `/components/movies/v3/Header` | `/components/movies/v3/HomeCard` | `/components/movies/v4` | `/components/movies/v4/Button` | `/components/movies/v4/HintLayout` | `/components/movies/v4/IconButton` | `/components/movies/v4/LoadingLayout` | `/components/movies/v4/MediaCard` | `/components/movies/v4/MediaGrid` | `/components/movies/v4/Text` | `/components/paper` | `/components/paper/BottomBar` | `/components/paper/Button` | `/components/paper/Cards/Evidence` | `/components/paper/Cards/Ghost` | `/components/paper/Cards/Introduction` | `/components/paper/Cards/Settings` | `/components/paper/Cards/Timer` | `/components/paper/Cards/Tool` | `/components/paper/Picker` | `/components/tiktok/v1` | `/components/tiktok/v1/Feed` | `/components/tiktok/v2` | `/components/tiktok/v2/AuthDetails` | `/components/tiktok/v2/AuthMenu` | `/components/tiktok/v2/ChatListItem` | `/components/tiktok/v2/ChatSingleItem` | `/components/tiktok/v2/CommentItem` | `/components/tiktok/v2/CommentModal` | `/components/tiktok/v2/Modal` | `/components/tiktok/v2/NavBarGeneral` | `/components/tiktok/v2/PostSingle` | `/components/tiktok/v2/PostSingleOverlay` | `/components/tiktok/v2/ProfileHeader` | `/components/tiktok/v2/ProfileNavBar` | `/components/tiktok/v2/ProfilePostList` | `/components/tiktok/v2/ProfilePostListItem` | `/components/tiktok/v2/SearchUserItem` | `/components/tinder/v1` | `/components/tinder/v1/CardItem` | `/components/tinder/v1/City` | `/components/tinder/v1/Filter` | `/components/tinder/v1/Icon` | `/components/tinder/v1/Message` | `/components/tinder/v1/ProfileItem` | `/components/tinder/v3/Text` | `/components/translator` | `/components/translator/ButtonBase` | `/components/translator/ButtonBorderLess` | `/components/translator/InputBase` | `/components/translator/TypoGraphy` | `/components/ubereats/forms` | `/components/ubereats/forms/AppErrorMessage` | `/components/ubereats/forms/AppForm` | `/components/ubereats/forms/AppFormFeilds` | `/components/ubereats/forms/AppSubmitButton` | `/components/ubereats/forms/ImageInput` | `/components/ubereats/others` | `/components/ubereats/others/About` | `/components/ubereats/others/AppButton` | `/components/ubereats/others/AppHead` | `/components/ubereats/others/CartItems` | `/components/ubereats/others/Categories` | `/components/ubereats/others/CheckoutModal` | `/components/ubereats/others/HeaderTabs` | `/components/ubereats/others/MenuItems` | `/components/ubereats/others/OtherSignin` | `/components/ubereats/others/PaymentButton` | `/components/ubereats/others/PaymentScreen` | `/components/ubereats/others/RestaurantItem` | `/components/ubereats/others/RestaurantMap` | `/components/ubereats/others/Screen` | `/components/ubereats/others/SearchBar` | `/components/ubereats/others/TabCartButton` | `/components/ubereats/others/ViewCart` | `/components/world` | `/components/world/Capital` | `/components/world/Continent` | `/components/world/Country` | `/components/world/Friends` | `/components/world/Post` | `/components/youtube/v1` | `/components/youtube/v1/Buttons` | `/components/youtube/v1/Explore` | `/components/youtube/v1/Navbar` | `/components/youtube/v1/Posts` | `/components/youtube/v1/Sidebar` | `/components\dating\v3\` | `/components\dating\v3\Common\Header` | `/components\dating\v3\common\Header` | `/constants` | `/constants/colors` | `/constants/data` | `/constants/fonts` | `/constants/icons` | `/constants/images` | `/constants/styles` | `/constants/svgs` | `/constants/urls` | `/contexts/movies/v4/DetailsContext` | `/contexts/movies/v4/SearchContext` | `/contexts/movies/v4/TrendingContext` | `/contexts/translator/CardSequenceContext` | `/contexts/translator/HistoryContext` | `/contexts/translator/TranslateContext` | `/hooks/instagram/v2/useKeyboard` | `/hooks/tiktok/v2/queryKeys` | `/hooks/tiktok/v2/useChats` | `/hooks/tiktok/v2/useFollowing` | `/hooks/tiktok/v2/useFollowingMutation` | `/hooks/tiktok/v2/useMaterialNavBarHeight` | `/hooks/tiktok/v2/useMessages` | `/hooks/tiktok/v2/useUser` | `/hooks/translator/useKeyboard` | `/hooks/translator/useNavigation` | `/hooks/translator/useRoute` | `/routes` | `/routes/drawers/athena` | `/routes/drawers/translator/home` | `/routes/drawers/world/main` | `/routes/stacks/athena` | `/routes/stacks/basketball` | `/routes/stacks/chatgpt/v1` | `/routes/stacks/chatgpt/v1/auth` | `/routes/stacks/chatgpt/v1/home` | `/routes/stacks/dating/v1` | `/routes/stacks/dating/v2` | `/routes/stacks/dating/v2/categories` | `/routes/stacks/dating/v2/home` | `/routes/stacks/dating/v2/search` | `/routes/stacks/dating/v3` | `/routes/stacks/dating/v3/chat` | `/routes/stacks/dating/v3/events` | `/routes/stacks/dating/v3/match` | `/routes/stacks/dating/v3/profile` | `/routes/stacks/disney/v1` | `/routes/stacks/disney/v1/downloads` | `/routes/stacks/disney/v1/home` | `/routes/stacks/disney/v1/main` | `/routes/stacks/disney/v1/profile` | `/routes/stacks/disney/v1/search` | `/routes/stacks/disney/v2` | `/routes/stacks/famous` | `/routes/stacks/fitness/v1` | `/routes/stacks/fitness/v1/auth` | `/routes/stacks/fitness/v1/home` | `/routes/stacks/instagram/v1` | `/routes/stacks/instagram/v1/main` | `/routes/stacks/instagram/v2` | `/routes/stacks/instagram/v2/explore` | `/routes/stacks/movies/v2` | `/routes/stacks/movies/v2/main` | `/routes/stacks/movies/v3` | `/routes/stacks/movies/v3/main` | `/routes/stacks/movies/v4` | `/routes/stacks/movies/v4/main` | `/routes/stacks/paper` | `/routes/stacks/tiktok/v1` | `/routes/stacks/tiktok/v1/discover` | `/routes/stacks/tiktok/v1/home` | `/routes/stacks/tiktok/v1/inbox` | `/routes/stacks/tiktok/v1/profile` | `/routes/stacks/tiktok/v2` | `/routes/stacks/tiktok/v2/feed` | `/routes/stacks/tiktok/v2/main` | `/routes/stacks/tinder/v1` | `/routes/stacks/tinder/v2` | `/routes/stacks/tinder/v3` | `/routes/stacks/translator` | `/routes/stacks/translator/home` | `/routes/stacks/ubereats` | `/routes/stacks/ubereats/auth` | `/routes/stacks/ubereats/home` | `/routes/stacks/world` | `/routes/stacks/world/auth` | `/routes/stacks/world/feed` | `/routes/stacks/world/home` | `/routes/stacks/world/profile` | `/routes/stacks/youtube/v1` | `/routes/tabs/athena` | `/routes/tabs/chatgpt/v1/bottom` | `/routes/tabs/dating/v2/bottom` | `/routes/tabs/dating/v3/bottom` | `/routes/tabs/disney/v1/bottom` | `/routes/tabs/fitness/v1/bottom` | `/routes/tabs/instagram/v1/bottom` | `/routes/tabs/instagram/v2/bottom` | `/routes/tabs/movies/v4/bottom` | `/routes/tabs/tiktok/v1/bottom` | `/routes/tabs/tiktok/v2/bottom` | `/routes/tabs/tinder/v1/bottom` | `/routes/tabs/tinder/v3/bottom` | `/routes/tabs/ubereats/bottom` | `/routes/tabs/world/bottom` | `/screens/athena` | `/screens/athena/Language` | `/screens/athena/Slides` | `/screens/athena/Theme` | `/screens/basketball` | `/screens/basketball/Home` | `/screens/basketball/Splash` | `/screens/chatgpt/v1` | `/screens/chatgpt/v1/auth/SignIn` | `/screens/chatgpt/v1/auth/SignUp` | `/screens/chatgpt/v1/auth/Welcome` | `/screens/chatgpt/v1/main/Chat` | `/screens/chatgpt/v1/main/Home` | `/screens/chatgpt/v1/main/Profile` | `/screens/chatgpt/v1/main/Saved` | `/screens/dating/v1/Detail` | `/screens/dating/v1/Home` | `/screens/dating/v2/Categories/Home` | `/screens/dating/v2/Events/Detail` | `/screens/dating/v2/Events/Home` | `/screens/dating/v2/Home/Main` | `/screens/dating/v2/Home/Splash` | `/screens/dating/v2/Search/Main` | `/screens/dating/v3` | `/screens/dating/v3/auth/Splash` | `/screens/dating/v3/chat` | `/screens/dating/v3/events` | `/screens/dating/v3/match` | `/screens/dating/v3/profile` | `/screens/disney/v1` | `/screens/disney/v1/Downloads` | `/screens/disney/v1/Home` | `/screens/disney/v1/ModalAddProfile` | `/screens/disney/v1/ModalManageProfiles` | `/screens/disney/v1/ModalVideo` | `/screens/disney/v1/ModalWebView` | `/screens/disney/v1/Profile` | `/screens/disney/v1/ProfileAppSettings` | `/screens/disney/v1/ProfileWatchlist` | `/screens/disney/v1/Search` | `/screens/disney/v1/Splash` | `/screens/disney/v2` | `/screens/disney/v2/Detail` | `/screens/disney/v2/Home` | `/screens/disney/v2/Main` | `/screens/disney/v2/Search` | `/screens/disney/v2/Splash` | `/screens/famous` | `/screens/famous/Choose` | `/screens/famous/Finish` | `/screens/famous/Game` | `/screens/famous/Splash` | `/screens/famous/Welcome` | `/screens/fitness/v1` | `/screens/fitness/v1/auth/SignIn` | `/screens/fitness/v1/auth/SignUp` | `/screens/fitness/v1/auth/Start` | `/screens/fitness/v1/home` | `/screens/instagram/v1` | `/screens/instagram/v1/Activity` | `/screens/instagram/v1/Home` | `/screens/instagram/v1/Profile` | `/screens/instagram/v1/Reels` | `/screens/instagram/v1/Search` | `/screens/instagram/v1/Splash` | `/screens/instagram/v2` | `/screens/instagram/v2/AddNewPost` | `/screens/instagram/v2/Explore` | `/screens/instagram/v2/ExploreDetail` | `/screens/instagram/v2/Home` | `/screens/instagram/v2/Notifications` | `/screens/instagram/v2/Post` | `/screens/instagram/v2/Posts` | `/screens/instagram/v2/Profile` | `/screens/instagram/v2/Splash` | `/screens/instagram/v2/Stories` | `/screens/instagram/v2/TaggedPhotos` | `/screens/instagram/v2/UserInfo` | `/screens/instagram/v2/UserPhotos` | `/screens/instagram/v2/ViewStory` | `/screens/movies/v2` | `/screens/movies/v2/Home` | `/screens/movies/v2/Movies` | `/screens/movies/v2/Person` | `/screens/movies/v2/Search` | `/screens/movies/v2/Splash` | `/screens/movies/v3` | `/screens/movies/v3/Details` | `/screens/movies/v3/Home` | `/screens/movies/v3/Splash` | `/screens/movies/v4` | `/screens/movies/v4/Splash` | `/screens/movies/v4/detail` | `/screens/movies/v4/detail/Details` | `/screens/movies/v4/detail/Heading` | `/screens/movies/v4/detail/Recommended` | `/screens/movies/v4/detail/VideoPlayer` | `/screens/movies/v4/home` | `/screens/movies/v4/home/Banner` | `/screens/movies/v4/home/Header` | `/screens/movies/v4/home/Trending` | `/screens/movies/v4/search` | `/screens/movies/v4/search/SearchInput` | `/screens/movies/v4/search/SearchResults` | `/screens/paper` | `/screens/paper/Home` | `/screens/paper/Splash` | `/screens/tiktok/v1` | `/screens/tiktok/v1/discover` | `/screens/tiktok/v1/home` | `/screens/tiktok/v1/home/feed` | `/screens/tiktok/v1/inbox` | `/screens/tiktok/v1/profile` | `/screens/tiktok/v1/splash` | `/screens/tiktok/v2` | `/screens/tiktok/v2/Auth` | `/screens/tiktok/v2/Cameras` | `/screens/tiktok/v2/ChatSingle` | `/screens/tiktok/v2/Chats` | `/screens/tiktok/v2/EditProfile` | `/screens/tiktok/v2/EditProfileField` | `/screens/tiktok/v2/Feed` | `/screens/tiktok/v2/Profile` | `/screens/tiktok/v2/SavePost` | `/screens/tiktok/v2/Search` | `/screens/tiktok/v2/Splash` | `/screens/tinder/v1` | `/screens/tinder/v1/Home` | `/screens/tinder/v1/Matches` | `/screens/tinder/v1/Messages` | `/screens/tinder/v1/Profile` | `/screens/tinder/v1/Splash` | `/screens/tinder/v2` | `/screens/tinder/v2/Home` | `/screens/tinder/v2/Splash` | `/screens/tinder/v3/Matches` | `/screens/tinder/v3/Messages` | `/screens/tinder/v3/Profile` | `/screens/tinder/v3/Splash` | `/screens/tinder/v3/Swipe` | `/screens/translator` | `/screens/translator/card-sequence` | `/screens/translator/card-sequence/Header` | `/screens/translator/card-sequence/TranslatorCard` | `/screens/translator/credit` | `/screens/translator/full` | `/screens/translator/history` | `/screens/translator/history/Header` | `/screens/translator/history/HistoryCard` | `/screens/translator/home` | `/screens/translator/home/DrawerContent` | `/screens/translator/home/Header` | `/screens/translator/home/Input` | `/screens/translator/home/LanguageSelector` | `/screens/translator/home/RecentCard` | `/screens/translator/home/TranslatedCard` | `/screens/translator/oss` | `/screens/translator/oss/Card` | `/screens/translator/oss/Header` | `/screens/translator/splash` | `/screens/ubereats` | `/screens/ubereats/auth/SignIn` | `/screens/ubereats/auth/SignUp` | `/screens/ubereats/auth/Welcome` | `/screens/ubereats/main/Account` | `/screens/ubereats/main/Browser` | `/screens/ubereats/main/Cart` | `/screens/ubereats/main/Checkout` | `/screens/ubereats/main/Details` | `/screens/ubereats/main/Grocery` | `/screens/ubereats/main/Home` | `/screens/ubereats/main/Success` | `/screens/world` | `/screens/world/auth/SignIn` | `/screens/world/auth/SignUp` | `/screens/world/auth/Start` | `/screens/world/feed` | `/screens/world/home` | `/screens/world/profile` | `/screens/youtube/v1` | `/screens/youtube/v1/Home` | `/screens/youtube/v1/Splash` | `/services/apis/athena/auth` | `/services/apis/dating/v2/categories` | `/services/apis/famous/main` | `/services/apis/fitness/v1/main` | `/services/apis/movies/v2/moviedb` | `/services/apis/movies/v4/tmdb` | `/services/apis/tiktok/v2/chat` | `/services/apis/tiktok/v2/posts` | `/services/apis/tiktok/v2/user` | `/services/apis/tiktok/v2/utils` | `/services/apis/world/main` | `/stores` | `/stores/athena` | `/stores/athena/auth` | `/stores/fitness/v1/main` | `/stores/tiktok/v2/auth` | `/stores/tiktok/v2/chat` | `/stores/tiktok/v2/modal` | `/stores/tiktok/v2/post` | `/stores/ubereats/auth` | `/stores/ubereats/basket` | `/stores/world/main` | `/styles/dating/v2/categories` | `/styles/dating/v2/events` | `/styles/dating/v2/home` | `/styles/dating/v2/search` | `/styles/tiktok/v1` | `/styles/tiktok/v1/discover` | `/styles/tiktok/v1/feed` | `/styles/tiktok/v1/home` | `/styles/tiktok/v1/inbox` | `/styles/tiktok/v1/profile` | `/styles/tiktok/v2` | `/styles/tiktok/v2/button` | `/styles/tiktok/v2/general` | `/styles/tinder/v1` | `/types/athena` | `/types/tiktok/v2` | `/types/translator` | `/types/translator/declarations.d` | `/utils` | `/utils/device` | `/utils/firebase` | `/utils/http` | `/utils/i18n` | `/utils/movies-v4` | `/utils/preload/fonts` | `/utils/storage` | `/utils/tmdb-api` | `/utils/translate` | `/utils/vector`;
